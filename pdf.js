...
if (source === 'link3') {
  ...
  fullname.innerHTML = personalAccountUser.thirddoc.name
  dateofbirth.innerHTML = personalAccountUser.thirddoc.datebirth
  aliennumber.innerHTML = personalAccountUser.thirddoc.aliennum
  passnumber.innerHTML = personalAccountUser.thirddoc.pasnum
  expdate.innerHTML = personalAccountUser.thirddoc.expdate
}