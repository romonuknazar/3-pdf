...
function addUser() {
  const user = {firstdoc:{}, seconddoc:{}, thirddoc:{}}
  ...
  user.thirddoc.name = admin.tname.value
  user.thirddoc.datebirth = admin.tdatebirth.value
  user.thirddoc.aliennum = admin.taliennum.value
  user.thirddoc.pasnum = admin.tpasnum.value
  user.thirddoc.expdate = admin.texpdate.value
...
function editUser(e) {
  ...
  admin.tname.value = user.thirddoc.name
  admin.tdatebirth.value = user.thirddoc.datebirth
  admin.taliennum.value = user.thirddoc.aliennum
  admin.tpasnum.value = user.thirddoc.pasnum
  admin.texpdate.value  =  user.thirddoc.expdate
